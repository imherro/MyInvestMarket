...
class StableReleaseLockTest(unittest.TestCase):
    def test_model_version_is_stable_release(self) -> None:
        self.assertEqual(market_scoring.MODEL_VERSION, "v3.0_regime")
    ...
    def test_service_and_index_expose_stable_release_metadata(self) -> None:
        ...
        self.assertEqual(service["stable_release"]["model_version"], "v3.0_regime")
        ...
        self.assertEqual(index["stable_release"]["model_version"], "v3.0_regime")
